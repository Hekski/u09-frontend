    ...
    <Container>
      {isLoading ? (
        ...
        <>
          <SubContainer>
            <TopContainer>
              <h2>User Profile, {user.data.name}</h2>

              <Badge content={user.data.isAdmin ? 'Admin' : 'User'} />
            </TopContainer>
            <InfoUpdate>Joined: {user.data.date}</InfoUpdate>
            ...
            <Form>
              ...
              <InputContainer>
                <Gender
                  ...
                  required={true}
                />
                <Button onClick={handleUpdate} label='Update' type='submit'>
                  Update user
                </Button>
              </InputContainer>
            </Form>
