...
spotifyApi.getArtistTopTracks('0oSGxfWSnnOXhD2fKuz2Gy', 'GB').then(
   function (data) {
      console.log(data.body);
   },
   function (err) {
...
// Get a user
spotifyApi.getUser('petteralexis').then(
   function (data) {
...
spotifyApi
   .reorderTracksInPlaylist('5ieJqeLJjjI8iJWaxeBLuK', 0, 10, options)
   .then(
      function (data) {
...
/* Follow a user */
spotifyApi.followUsers(['thelinmichael']).then(
   function (data) {
      console.log(data);
   },
   function (err) {
...
/* Follow an artist */
spotifyApi
   .followArtists(['2hazSY4Ef3aB9ATXW7F5w3', '6J6yx1t3nwIDyPXk5xa7O8'])
   .then(
      function (data) {
         console.log(data);
      },
...
/* Unfollow a user */
spotifyApi.unfollowUsers(['thelinmichael']).then(
   function (data) {
      console.log(data);
   },
   function (err) {
...
/* Unfollow an artist */
spotifyApi
   .unfollowArtists(['2hazSY4Ef3aB9ATXW7F5w3', '6J6yx1t3nwIDyPXk5xa7O8'])
   .then(
      function (data) {
         console.log(data);
      },
...
spotifyApi.isFollowingUsers(usersId).then(
   function (data) {
...
spotifyApi.isFollowingArtists(artistsId).then(
   function (data) {
      let isFollowing = data.body;
...
spotifyApi.containsMySavedTracks(['5ybJm6GczjQOgTqmJ0BomP']).then(
   function (data) {
...
spotifyApi.containsMySavedAlbums(['1H8AHEB8VSE8irHViGOIrF']).then(
   function (data) {
...
spotifyApi.removeFromMySavedAlbums(['1H8AHEB8VSE8irHViGOIrF']).then(
   function (data) {
      console.log('Removed!');
   },
   function (err) {
...
spotifyApi.addToMySavedAlbums(['1H8AHEB8VSE8irHViGOIrF']).then(
   function (data) {
